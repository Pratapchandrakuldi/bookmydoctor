...
<html lang="en">
  ...
  <body>
    ...
    <div class="card text-bg-dark rounded-0 border border-0">
      <img src="../picture/homepic.png" height="400px" class="card-img rounded-0" alt="Image not found">
    </div>
    <!-- end picture area-->

    <div style="margin:auto;">
      <p style="font-size:30px;text-align:centre;padding-top:20px;" class="text-center"><b>Our Featured Service</b></p>
    </div>

    <div>
      <p class="text-center" style="padding-left:40px;padding-right:40px;">
        First thing to understand here is that websites like more are more than just healthcare professional & facility
        directories .These websites also allow patients to
        schedule appointments with doctors & clinics.Thus ,it becomes imprative that besides providing listing of
        doctors, Our website also offers features
        that help healthcare professionals to manage appointments & their medical practice seamlessly.
      </p>
    </div>
