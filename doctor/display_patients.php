<?php
   session_start();
      ...
      $sql="SELECT p.patname,p.patcontact,p.patdate,p.pattime,p.pat_id,d.drname FROM patientdetails As p,dr_registration AS d WHERE d.regid=p.pat_drname  AND p.pat_drname='{$logid}' ";
