...
if(isset($_POST['reg_edrname'])){
       ...
       $reg_epassword=$_POST['reg_epassword'];
     ...
     d.drcontact ='{$reg_edrcontact}',d.drvshr ='{$reg_edrvshr}',d.drcharge ='{$reg_edrcharge}',d.dremail ='{$reg_edremail}',d.drpassword ='{$reg_epassword}' WHERE regid='{$registrationId}' AND  s.specialid=d.reg_special  AND l.locid=d.reg_loc AND c.cityid=l.city_name";
