...
<html lang="en">
  ...
  <body>
    ...
    <div class="card text-bg-dark rounded-0 border border-0">
      <img src="../picture/adminpic.jpg" height="400px" class="card-img rounded-0" alt="Image not found">
    </div>
    <div class="d-grid gap-2">
      <button class="btn btn-primary  rounded-0 fw-bolder" type="button">Admin Log-in</button>
    </div>
    ...
    <form method="post">
      ...
      <div class="row gx-3 gy-0 align-items-center">
        ...
        <div class="col-4 d-grid gap-2 d-md-flex justify-content-md-end">
          <button class="btn btn-primary me-md-2" type="submit"  id="login" name="login">Log-in</button>
